...
const projects = [
  {
    ...
    description: 'A full-stack e-commerce platform with features like product management, cart functionality, and secure payments using Stripe integration.',
  ...
  },
  {
    ...
    description: 'Real-time collaborative task management application with features like task assignment, due dates, and team chat.',
  ...
  },
  {
    ...
    description: 'A modern and responsive portfolio website built with Next.js and Tailwind CSS, featuring dark mode and animations.',
  ...
  },
  {
    ...
    description: 'Real-time weather dashboard with location search, forecast data, and interactive weather maps.',
  ...
  },
  {
    ...
    description: 'Microservice-based API gateway handling authentication, rate limiting, and request routing.',
  ...
  },
  {
    ...
    description: 'Headless CMS built with Node.js and GraphQL, featuring role-based access control and content versioning.',
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      >
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          ...
          from frontend applications to full-stack solutions.
        </p>
      </motion.div>
