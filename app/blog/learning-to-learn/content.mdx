...
While all the lessons in this course are meaningful, I will only talk about a handful of the lessons I learned from the material and I have structured the next section to talk about each lesson in the category where they were organized in the course.

## Principles

While all the sections in this course are important, this section is foundational to the rest. In this section, Andrei uncovers some truths about the world that help shape the rest of the course. Much of this section is dedicated to “reshaping our mind to look at the world in a different way.”
...
The reason this is essential to your learning is if you are not happy, you are automatically at a disadvantage in your learning. Information is harder to retain, obstacles are challenging to overcome, and failure feels magnified when you aren’t happy 😰
